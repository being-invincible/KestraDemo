...
def parse_api():
  """
  Function for passing argument into the python program file
  """
...
# Outputs
df.to_csv("./convenience_stores_coventry.csv", index=False)
Kestra.outputs({
    "Message": "Extraction Complete!",
    "storesData": df.to_dict()
})